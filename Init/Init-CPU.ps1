...
&.\MultiPoolMiner.ps1 -wallet 3BtgUnw3Rax59p8Fmk4VSgsH1BsYvJH1GP -username pauldmurphy -workername $env:AZ_BATCH_POOL_ID -interval 120 -Region $(GetPoolLocation) -ssl -type cpu -algorithm cryptonight -poolname MiningPoolHub,NiceHash -currency btc,usd -donate 10
#.\MultiPoolMiner.ps1 -wallet 3BtgUnw3Rax59p8Fmk4VSgsH1BsYvJH1GP -username pauldmurphy -workername $env:AZ_BATCH_POOL_ID -interval 120 -Region $(GetPoolLocation) -ssl -type cpu -algorithm Bitcore,Blakecoin,Blake2s,BlakeVanilla,C11,CryptoNight,Ethash,X11,Decred,Equihash,Groestl,HMQ1725,JHA,Keccak,Lbry,Lyra2RE2,Lyra2z,MyriadGroestl,NeoScrypt,Nist5,Pascal,Quark,Qubit,Scrypt,SHA256,Sia,Sib,Skunk,Skein,Timetravel,Tribus,BlakeVanilla,Veltor,X11,X11evo,X17,Yescrypt -poolname MiningPoolHub,NiceHash -currency btc,usd -donate 10