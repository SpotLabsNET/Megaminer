...
if (($Querymode -eq "core" ) -or ($Querymode -eq "Menu")){
        ...
        $Pools +=[pscustomobject]@{"coin"="ZCASH";     "algo"="Equihash";       "symbol"="ZEC";  "server"="zec-eu.suprnova.cc";   "port"="2142"; "location"="EU"};
        $Pools +=[pscustomobject]@{"coin"="ZCASH";     "algo"="Equihash";       "symbol"="ZEC";  "server"="zec-apac.suprnova.cc"; "port"="2142"; "location"="AP"};
        $Pools +=[pscustomobject]@{"coin"="ZCOIN";     "algo"="LYRA2Z";         "symbol"="XZC";  "server"="xzc.suprnova.cc";      "port"="1569"; "location"="US"};
        $Pools +=[pscustomobject]@{"coin"="ZCOIN";     "algo"="LYRA2Z";         "symbol"="XZC";  "server"="xzc.suprnova.cc";      "port"="1569"; "location"="EU"};
        $Pools +=[pscustomobject]@{"coin"="ZCOIN";     "algo"="LYRA2Z";         "symbol"="XZC";  "server"="xzc-apac.suprnova.cc"; "port"="1569"; "location"="AP"};
